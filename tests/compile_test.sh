mkdir -p exe_files
g++ -O0 -o exe_files/Binary_Hash_Test.out0 Test.cpp ../Binary_Hash.hpp
g++ -O1 -o exe_files/Binary_Hash_Test.out1 Test.cpp ../Binary_Hash.hpp
g++ -O2 -o exe_files/Binary_Hash_Test.out2 Test.cpp ../Binary_Hash.hpp
g++ -O3 -o exe_files/Binary_Hash_Test.out3 Test.cpp ../Binary_Hash.hpp
